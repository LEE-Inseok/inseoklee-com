...
→ Built with the [SBH Thermal Reactor Framework](/development/sbh-framework).
→ Next: [CCPP-LOHC Optimization](/research/ccpp-lohc) applies the same method at MW scale.
